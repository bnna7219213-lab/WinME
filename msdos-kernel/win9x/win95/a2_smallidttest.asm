; Test with small IDT (32 entries instead of 256)
BITS 16
ORG 0x0000
...
pm32_entry:
    ...
    ; Build IDT (small)
    mov     edi, idt_table
    mov     ecx, 32 * 2        ; 32 entries * 2 dwords = 256 bytes
    xor     eax, eax
    rep     stosd
    ; int 0x0D
...
ALIGN 8
idt_table:
    times 32*8 db 0         ; 32 entries = 256 bytes
idt_descriptor:
    dw      32 * 8 - 1
